...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BFKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5BFKit8BFButton")
...
SWIFT_CLASS("_TtC5BFKit11BFTextField")
...
@interface UIDevice (SWIFT_EXTENSION(BFKit))
+ (void)lowPowerModeChanged:(void (^ _Nonnull)(BOOL))block SWIFT_AVAILABILITY(ios,introduced=9.0);
@end
...
@interface UIView (SWIFT_EXTENSION(BFKit))
